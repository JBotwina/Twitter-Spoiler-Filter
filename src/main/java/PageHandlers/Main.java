...
public class Main {
    public static void main(String[] args) {
    	...
    	get("/filteredFeed", (req, res) -> {	
    		...
    		return "<div class = \"container\">" + filteredFeed.getHeader() + keywordDisplay + filteredFeed.getHomeButton() + "<div>"+filteredFeed.getHiddenFeedButton() + "</div>" + filteredFeed.getBootstrapJS() + "</div>" + filteredFeed.getTweetInfo(keyword);
    	});
